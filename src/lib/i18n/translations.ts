...
export const translations: TranslationMap = {
  ...
  'app.tagline': { nb: 'Planlegg din Nord-Norge-reise', en: 'Plan your Northern Norway trip' },
  'app.description': { nb: 'AI-drevet reiseplanlegger — skreddersydd for sesong, budsjett og interesser', en: 'AI-powered travel planner — tailored for season, budget and interests' },
  ...
  'onboarding.velg-interesser': { nb: 'Hva vil du oppleve?', en: 'What do you want to experience?' },
  'onboarding.velg-interesser-desc': { nb: 'Velg interesser for å skreddersy reiseruten. Maks 5 valg.', en: 'Select interests to tailor the itinerary. Max 5 choices.' },
  'onboarding.velg-sesong': { nb: 'Når vil du reise?', en: 'When do you want to travel?' },
  'onboarding.velg-varighet': { nb: 'Hvor lenge vil du reise?', en: 'How long do you want to travel?' },
  'onboarding.velg-budsjett': { nb: 'Hva er budsjettet?', en: 'What is your budget?' },
  'onboarding.velg-started': { nb: 'Hvor starter reisen?', en: 'Where does the trip start?' },
  'onboarding.oppsummering-tittel': { nb: 'Oppsummering', en: 'Summary' },
  'onboarding.oppsummering-desc': { nb: 'Se over valgene dine før vi genererer reiseplanen.', en: 'Review your choices before we generate the itinerary.' },
  'onboarding.minst-en': { nb: 'Velg minst én interesse for å fortsette', en: 'Select at least one interest to continue' },
  ...
  'itinerary.regenerer-dag': { nb: 'Regenerer denne dagen', en: 'Regenerate this day' },
  ...
  'trips.dine-reiser': { nb: 'Dine lagrede reiseplaner', en: 'Your saved trip plans' },
  'trips.ny-reise': { nb: 'Ny reise', en: 'New Trip' },
  'trips.ingen': { nb: 'Ingen reiser enda', en: 'No trips yet' },
  'trips.ingen-desc': { nb: 'Start med å planlegge din første reise til Nord-Norge.', en: 'Start planning your first trip to Northern Norway.' },
  'trips.logg-inn-tittel': { nb: 'Logg inn for å se dine reiser', en: 'Sign in to see your trips' },
  'trips.logg-inn-desc': { nb: 'Du må være logget inn for å lagre og se reiseplanene dine.', en: 'You need to be signed in to save and view your trip plans.' },
  ...
  'landing.populaere': { nb: 'Populære destinasjoner', en: 'Popular destinations' },
  'landing.hvorfor': { nb: 'Hvorfor NordVoyager?', en: 'Why NordVoyager?' },
  'landing.opplevelser': { nb: 'Opplevelser vi kan planlegge', en: 'Experiences we can plan' },
  'landing.klar': { nb: 'Klar for ditt neste arktiske eventyr?', en: 'Ready for your next Arctic adventure?' },
  ...
  'footer.copyright': { nb: 'AI-drevet reiseplanlegger for Nord-Norge', en: 'AI-powered travel planner for Northern Norway' },
  'ai.anbefaler': { nb: 'Jeg anbefaler', en: 'I recommend' },
  'ai.dager': { nb: 'dager i', en: 'days in' },
  'ai.klar': { nb: 'Klar til å generere din personlige reiseplan?', en: 'Ready to generate your personal itinerary?' },
  'ai.genererer': { nb: 'Genererer din reiseplan...', en: 'Generating your itinerary...' },
  'ai.genererer-desc': { nb: 'AI-en jobber med å skreddersy reisen etter dine ønsker.', en: 'The AI is tailoring the trip to your preferences.' },
  ...
  'generic.offline-desc': { nb: 'Du er offline. Dine lagrede reiseplaner er fortsatt tilgjengelige.', en: 'You are offline. Your saved trip plans are still available.' },
};
